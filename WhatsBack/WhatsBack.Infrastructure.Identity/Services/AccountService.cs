...
using WhatsBack.Infrastructure.Identity.Helpers;
...
namespace WhatsBack.Infrastructure.Identity.Services
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response<AuthenticationResponse>> AuthenticateAsync(AuthenticationRequest request, string ipAddress)
        {
            ...
            JwtSecurityToken jwtSecurityToken =  AuthenticationHelper.GenerateJWToken(_jwtSettings, user.Id,
                userClaims.Select(x => new Claim(x.Type, x.Value)).ToList(), roleClaims);
            ...
            var refreshToken = AuthenticationHelper.GenerateRefreshToken(ipAddress);
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var verificationUri = await AuthenticationHelper.SendVerificationEmail(user, origin, _userManager);
